...
reviews = [
  ...
  It definitely worked its magic over the salad lunch line, as well as the cashier line by the time I got to it.

  I liked that they offered a few cooked veggie options, such as the broccoli, grilled white onion, and roasted brussel sprouts, as well as tri-colored carrot coins, a 3 grain blend, and gogi mix (not that I tried the last one, yet).  Their croutons are rather large, but quite flavorful.  They nixed romaine lettuce as a salad base due to the current outbreak in the news.  And the young black gentleman at the register was a pleasure to work with.

  Note to self: opt for the crunchies on the side, not chopped into the salad.

  *** 3/2018 lunch ***

  Build Your Own Salad is now $8.49.  The menu says it comes with freshly baked flatbread... they didn't give me any; was I supposed to grab some myself?" },
  { rating: 100, user_id: 2, restaurant_id: 1, comment: "World's BEST Grilled Cheese (V) $6.99 - 12-month aged Cheddar, Cheddar cheese curds, roasted tomato jam

  I gave Uno Due Go's self proclaimed World's Best grilled cheese a chance.  Its time in the heat took longer than the two sandwiches ordered after me.  It then sweated through the wrapping on the counter as I paid, leaving a damp shadow in its wake.

  Still, after I unwrapped it while in the UDG dining area and started on the first half, there was a nice consistent toasted crisp chew to the bread, but it rather light on the jam and definitely not the best grilled cheese I ever had.  The second half softened as it sat on the table waiting for its turn to be consumed; perhaps I should have set it on its side to help it to retain its crispness?

  I could have had my choice of a build your own sandwich, with a protein!, for the same $6.99, and might have enjoyed it all the better.

  Note: 5-7pm 1/2 off bakery goods" },
  { rating: 80, user_id: 3, restaurant_id: 1, comment: "I ordered a breakfast sandwich wrap and the first bite wasn't good as it was all bread but once I got into the actual items in the wrap, I was surprised that it was very flavorful. I went and grabbed salt and pepper to season the wrap but it didn't need any which doesn't happen often at establishments.

  It was very clean in here, nice seating area and I like that you can grab your own coffee.   Very clean bathrooms which you need a code to get in.  Keeps you safe!  I would go here again when I'm in the area." },
  { rating: 20, user_id: 4, restaurant_id: 2, comment: "Decided to pop in and get some food ten minutes before closing time. There were two ladies behind the counter, and one politely informed me that I could only get my food to go as they were closing for the evening. No problem at all since I had come for takeout anyway.

  I ordered a kafta kabob platter and the lady who served me made sure I left thoroughly eatisfied, by throwing in an additional box of falafel (7 pieces!!!) and hummus for free. My order cost all of $10.85.

  I brought the food home and promptly devoured it -- no complaints whatsoever, it was still hot and fresh. Everything in the platter was delicious - the kafta kabobs were flavorful, the rice was nicely spiced, and the cucumber and tomato salad was surprisingly delicious (I may have enjoyed that the most out of everything). As for the side of falafel and hummus - the falafel were crisp on the outside and went really well with the creamy hummus.

  Kudos to Falafel King for affordable and tasty food, with great service! So glad this place is just a stone's throw from my place." },
  { rating: 60, user_id: 5, restaurant_id: 2, comment: "This is one of my go-to places for lunch. Love the falafels. They are so fresh and tastes amazing. Fan of the free falafel they hand out when they prepare our orders ;)
  ...
  The cheese was stringy and full of flavor and the fresh toppings blended together symphonically.

  The staff was friendly and genuinely cared about our dining experience.

  We made quick work of the first one so we ordered another.

  It was so good on our return trip today we got a couple more pizzas. Still amazing! I look forward to visiting the Oath locations in NYC." },
  { rating: 40, user_id: 5, restaurant_id: 5, comment: "Crust was crispy and buttery; more pastry like than the usual chewy pizza dough. Toppings were laughable with that few (5) cubes of tiny pineapple and non existence cheese.

  Given that it was NYE and there was this one lone soul feeding everyone, we finished the pizzas without complains.

  Reading the past reviews, I hoped that was a one off incident. Perhaps I will try the pizza again if I'm travelling on the commuter." },
  ...
  { rating: 100, user_id: 3, restaurant_id: 6, comment: "
  Damn, Bonapita has elevated my lunch to a whole new level!

  Came here not knowing anything about it, but have got to say, it's amazing! The meatballs are deliciously warm and soft and I don't know what they put in their zingy dressing but it is absolutely delicious. Who knew salad could taste so good?

  There's a reason this place is busy, it's because it's great! Highly recommended!" },
  { rating: 80, user_id: 2, restaurant_id: 6, comment: "I work in the area and used to come in for lunch fairly frequently (about once per week), but haven't been as much recently.

  Bonapita used to be my favorite lunch spot. The food and value were both worth 5/5 stars.

  Unfortunately the portion sizes have gone down quite significantly recently. First the pitas served with the rice plates started shrinking, and now the portions themselves are getting ridiculously small.

  While the bowls they serve the food in are still the same, the amount of food has gone down quite significantly.

  At first it was not enough for me to stop going, although the frequency at which I did went down with the portion sizes. After my most recent visit today however I'm sad to admit that the value (amount of food for the price) has gone down to the point where it's no longer worth going.
  ...
  { rating: 60, user_id: 3, restaurant_id: 7, comment: "I walked by here a couple times and today I decided I should give it a try since I did not bring lunch to work

  My first impression was how clean the place is.
  The place is spacious ( there's no seats indoors to eat). The sell breakfast, sandwiches & wraps. They also have snacks like chips, fruits, candy etc.

  I ordered a Tuna Melt sandwich without the bacon and it was really really good! They toasted the sandwich which made the sandwich that much better. The ladies there are very kind, easy to deal with. Very quick service no lines at the time I went (2pm)

  I will definitely be returning whenever I don't bring lunch to work or whenever i'm in the mood for a good sandwich." },
  ...
  { rating: 60, user_id: 6, restaurant_id: 8, comment: "
  Really enjoyed my MealPal lunch I ordered here today! I was in and out in under a minute and my meal was already packed in a bag with utensils ready to go. The oven roasted chicken bowl had quinoa in it which definitely made the meal more substantial. It also came with bread on the side which, despite being just straight up bread, was quite yummy and filling. The bowl itself had many different toppings like cranberries and butternut squash. The chicken portion was substantial but the chicken was a little dry - I guess that's to be expected with white chicken meat. Will be ordering from here again!

  - UPDATE #1: the pollo verdura bowl on MealPal was VERY carb-heavy with mostly pasta and some toppings and sauce on top. Not a fan of this one." },
  { rating: 40, user_id: 7, restaurant_id: 9, comment: "This is the kind of place that makes me feel healthy just stepping inside. The first thing you see is a row of fresh mint growing in the center of the store.

  We split a southwest salad which included my favorite salad ingredients-avocado, chicken and corn.
  ...
  Edited: The employee did apologize for the wait and give us complimentary sweet potato fries. The food was very hot and delicious. I just wish the service was more consistent at this location. Totally hit or miss." },
  { rating: 100, user_id: 9, restaurant_id: 9, comment: "This is a local chain fast food restaurant (apologies for the potential misuse of terminology). I am not sure what I was expecting but I was thoroughly impressed.

  A long line didn't translate to a long wait which is crucial during lunch hours AND the food was so fresh.

  I gave this place four stars as my Power Bowl was INCREDIBLY salty. I probably wouldn't order it again but would love to try something new.

  Highly recommend if you want a break from Clover" },
  { rating: 80, user_id: 9, restaurant_id: 10, comment: "All your hungover breakfast dreams come true with the Yahoo. It's a heavenly breakfast sandwich with your choice of meat (go bacon of course) AND they threw a hash brown on there.

  Love the guys yelling out the orders behind the counter. Feels like a true New York deli right in the heart of Boston. So good it almost makes me like New York...almost." },
  ...
  { rating: 60, user_id: 3, restaurant_id: 12, comment: "Lovely hole in the wall found and recommended by my friend who lives in Boston.

  They are a no frills, affordable, quick and delicious Bahn Mi restaurant.

  They're simple in what they offer but they do it well. You also can't beat the $4.25 price. Great find!" },
  ...
  { rating: 100, user_id: 1, restaurant_id: 12, comment: "Good Bahn Mi for a great price!

  The service is non-existent, but they get you the sandwich fast. The sandwich doesn't have too much meat, but the veges are fresh and the bread was fluffy, and hot when I got it. The one issue is that they put the entire cilantro stalk in it, which was a bit unpleasant.

  Otherwise, the flavor profile was great, especially considering the price point!" },
  ...
  { rating: 40, user_id: 2, restaurant_id: 13, comment: "This is a hole in the wall type of place. As soon as you go inside, you'll see the roasted meats hanging in the glass cabinet in their kitchen. The place is very small, probably less than ten tables available. Menu is short and simple, you choose how many types of meat you want with your meal.

  I do feel like I'm in Hong Kong or Singapore whenever I eat here. It tastes so authentic and the same as what you can get if you're in Asia. I would consider this one of my comfort foods. Would definitely recommend this place." },
  { rating: 80, user_id: 3, restaurant_id: 13, comment: "
  Been here since I was in high school and it never failed to meet my expectations . Every visit here is like the first time . The chicken with rice and veggies along with chicken soup that comes with the dish is always superb. I keep coming back for their chicken I think they put crack in their chicken cause you will definitely need a fix at least once a week coming in to this side street of Chinatown. People might think this place should be reported to the city inspectional services since it look so run down inside . I don't know why they never update and renovate the place with all the money they are making . Prices are affordable and reasonable here . They have ducks , spareribs , gizzards, chicken heart, thousand years eggs which you can tell them what you like . Cash only here so bring cash only" },
  { rating: 40, user_id: 4, restaurant_id: 14, comment: "Chicken and Rice Guys is perfectly simple and simply perfect. They only have a few choices, so their operation is really streamlined and their food is really consistent. It's the perfect style of food to supply lots of workers in the Downtown Crossing area.

  The chicken and rice are both always perfectly seasoned, and you can can customize your meal with sauces. The white garlic sauce is lighter than you would expect and really tasty. The mint/cilantro sauce is refreshing. It's best when you combine sauces and basically put everything on your chicken and rice together. The portion size is great, too.

  The service is really efficient and your food is usually out within a couple of minutes, even at the busiest times. It's my go-to when I'm looking for a quick lunch in the area.

  Also, try the baklava! It's gooey and rich and decadent." },
  { rating: 20, user_id: 5, restaurant_id: 14, comment: "So simple, but so good. I've eaten here a couple times and at their food truck way more times. While their food truck rice can be too dry, getting here means it always comes out perfectly. The portions are good for a cheap price, and the food comes out really quickly. Can't go wrong with Chicken and Rice Guys!

  Make sure you add their amazing white garlic sauce!" },
  { rating: 80, user_id: 6, restaurant_id: 14, comment: "If you want a cheap, fast, and delicious option that isn't like McDonald's or Chipotle, then Chicken and Rice Guys is where you should go! This restaurant an ode to Halal Guys in New York, and they do a good job.

  I usually go for lamb & beef gyro rice plate, add a bunch of creamy white sauce, and bam! I'm happy. I haven't tried any of their other sauces because I'm such a stickler for the OG sauce." },
  { rating: 100, user_id: 7, restaurant_id: 15, comment: "Becca and Brendan:
  ...
  As one user below said, don't expect THE BEST service at this place--which is how it should be. All in all, the food was delicious and relatively cheap. We will definitely be back again!" },
  { rating: 20, user_id: 8, restaurant_id: 15, comment: "
  It's busy. It's crowded. It's noisy. It's the best bowl of pho you'll get in Boston.

  Don't expect good service. You come here for the amazing food and the authenticity. People are yelling and rushing all around. It's exactly what it should be." },
  { rating: 60, user_id: 9, restaurant_id: 15, comment: "I have only had their pho - it is one of my go to pho places. It is always busy here no matter if you come during lunch or dinner - so always allow some extra time for waiting for a table and even after you are seated, there will be some wait for service; but that is what you usually can expect from a place that knows how to cook amazing food (pho - in this case). The portion is generous even if you're not getting the XL size soup and the broth is delicious and the amount of meat they throw in there is definitely more than enough and the price you just can't beat - under $10 and you will be so full you are practically rolling out of that place.

  This is one of my fave places in Chinatown - I might need to start expanding to other items on their menu...." },
  { rating: 60, user_id: 9, restaurant_id: 16, comment: "Beautiful presentation of food!
  Pretty good but not as much as it looks and also a little pricey.
  Overall not a bad experience and would recommend others to try once, but I personally would probably not come again. Not that anything was horrible, but just that it wasn't anything amazing." },
  { rating: 80, user_id: 8, restaurant_id: 16, comment: "Underground Japanese fare in the heart of Chinatown.

  Good: many options of Poke bowls to pick from, even more other donburi, protein over rice bowl, options for more of a substantial, dinner option. Fish was fresh, flavorful.

  Average: interior was nice, service was standard, prices were a bit on the higher end of what I expected but nothing unreasonable. Sauces can be a bit on the sweet/overextracted side.

  Bad: food took quite a while to come out. Surprisingly, since there weren't too many people there for our late lunch.

  Overall, a great spot for a healthy lunch/dinner in a sea of fried Chinese options!" },
  { rating: 40, user_id: 7, restaurant_id: 16, comment: "SAKE AISURU DON. It is actually incredible. It is a bowl with three different types of salmon (salmon sashimi, salmon toro sashimi, and minced, marinated salmon). Each of the three has a uniquely delicious taste. The salmon sashimi is wonderfully fresh, tender, and tastes great. The salmon toro sashimi (salmon belly) is even more rich, and the fat adds an extra layer of buttery taste to that salmon meat. The minced salmon is marinated in sesame oil, and tastes amazing. The minced form of the salmon gives you a different texture to change it up and add more variety to what you're chewing, and the sesame oil adds more personality to the salmon flavor without overpowering it. Each type of salmon complements the others and they contribute to a very special bowl of sake don.

  The restaurant feels very COZY and has a warm, homey vibe to it. Service was great, and prices are on the higher end, but reasonable for the amount and quality of raw fish you're getting ($17)." },
  { rating: 60, user_id: 6, restaurant_id: 17, comment: "My friend and I were starving really late one night and saw that there was Halal Guys for delivery. We ordered a crap ton of food and finished all of it against our better judgments. It was good, although I would say in general all the cuts of meat were pretty dry overall. But especially with that nondescript white sauce that came in these cheap looking plastic packets just drizzled all over everything, it was a pretty great meal.

  Highly recommend!" },
  { rating: 40, user_id: 5, restaurant_id: 17, comment: "This has the makings of a decent place, good flavor and consistency on the tahini, great pita bread.

  However, my main meal was ruined.  I put on the order ALLERGY WARNING CHICK PEAS/HUMMUS in all caps for the chicken gyro sandwich, and they put hummus on there.  It was a delivery order too so while got money back from doordash, it was the main part of the meal.

  Edit to owner:  if you are blaming door dash for your employees putting something I have an allergy to despite putting it in all caps in description, perhaps you should look into how you receive orders from them.  Plus my receipt had the description so nice try." },
  { rating: 40, user_id: 4, restaurant_id: 17, comment: "Not sure what the hype is about. I mean, it's good, but it didn't live up to my expectations based on what I'd heard about the NY food truck.

  My husband and I mainly come here because it's conveniently across the street from our apartment. Luckily, we've never run into a line, and service is always pretty fast. We typically split a regular size platter with either gyro or combo (chicken & gyro) meat. Everything tastes fine, but I think you can get better Halal food here in Boston." },
  { rating: 100, user_id: 3, restaurant_id: 18, comment: "If you are one of the lucky few that have found this place and ate here., then you have found one of the
  Greatest Deli Sandwich places in The world. The employees go out of their way to get you what you want, for example, extra deli pickles that are simply delicious. The hot pastrami with Swiss and sauerkraut on pumpernickel pressed bread, is like you went to heaven.

  This this place is the best on earth, hard to find, a diamond in the rough. Should I say anymore?" },
  { rating: 80, user_id: 2, restaurant_id: 18, comment: "If you are one of the lucky few that have found this place and ate here., then you have found one of the
  Greatest Deli Sandwich places in The world. The employees go out of their way to get you what you want, for example, extra deli pickles that are simple delicious. The hot pastrami with Swiss and sauerkraut on pumpernickel pressed bread, is like you went to heaven.
