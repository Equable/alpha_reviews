...
restaurants = [
	{ name: "Uno Due Go", street: '52 Summer Street.', city: 'Boston', state: 'MA', zip: '02110', description: 'Branch of a small casual chain offering pizza, baked goods, soups, salads & sandwiches.', image: 'https://s3-media4.fl.yelpcdn.com/bphoto/Eisw29so41x_OCRlxpKuXg/o.jpg', avg_rating: 5, avg_cost: '$'},
	{ name: "Falafel King", street: '62 Summer Street', city: 'Boston', state: 'MA', zip: '02110', description: 'Falafel King offers meals of excellent quality and invites you to try its delicious food.', image: 'https://s3-media4.fl.yelpcdn.com/bphoto/zYevmm7L6QF25CvFjVp-xA/o.jpg', avg_rating: 5, avg_cost: '$'},
	{ name: "5 Guys", street: '58 Summer Street', city: 'Boston', state: 'MA', zip: '02110', description: 'Fresh ingredients delivered daily and hand-prepared. Five Guys Knows Fries. Made-To-Order Burgers.', image: 'https://static.adweek.com/adweek.com-prod/wp-content/uploads/2018/09/five-guys-dc-spotlight-hed-page-2018.jpg', avg_rating: 5, avg_cost: '$$'},
	{ name: "Al Capone's", street: '82 Summer Street', city: 'Boston', state: 'MA', zip: '02110', description: 'With years in the business, Alcapone is proud to be one of the best restaurants in town. Our professional staff guarantee to deliver the most delicious dishes together with the quality services for the customers.', image: 'https://i.pinimg.com/originals/8e/91/d1/8e91d1836d450a12764fa7a81345ef8f.jpg', avg_rating: 5, avg_cost: '$'},
	{ name: "Oath Pizza", street: '700 Atlantic Ave', city: 'Boston', state: 'MA', zip: '02110', description: 'Certified Humane - Sustainable Ingredients | Oath Pizza.', image: 'https://cdn10.bostonmagazine.com/wp-content/uploads/sites/2/2017/08/Oath-Craft-Pizza-MrCrunch-8737.jpg', avg_rating: 5, avg_cost: '$'},
	{ name: "Bonapita", street: '49 Franklin Street', city: 'Boston', state: 'MA', zip: '02110', description: 'Modern counter serve with Mediterranean mains & housemade pitas, plus vegan & vegetarian options.', image: 'https://pbs.twimg.com/media/DGtsV2KXcAApEOw.jpg', avg_rating: 5, avg_cost: '$'},
	{ name: "Boston News Cafe", street: '80 Arch Street', city: 'Boston', state: 'MA', zip: '02110', description: 'Straightforward cafe offering coffee, bagels, sandwiches & salads to go, plus catering services.', image: 'https://igx.4sqi.net/img/general/600x600/F_z7sWcGRM4gsxXvbiE5VLUcHLW6N2sNjWXKuXRAXx0.jpg', avg_rating: 5, avg_cost: '$'},
	{ name: "Viga", street: '291 Devonshire Street', city: 'Boston', state: 'MA', zip: '02110', description: 'We are committed to providing you with the best quality food and service in a relaxed & friendly atmosphere.', image: 'http://vigaeatery.com/wp-content/uploads/2014/09/2-1500x694.jpg', avg_rating: 5, avg_cost: '$'},
	{ name: "B. Good", street: '84 Summer Street', city: 'Boston', state: 'MA', zip: '02110', description: 'Burgers, salads and bowls inspired by the seasons and ingredients rotated with the local harvests.', image: 'https://rappaportco.com/wp-content/uploads/2016/10/WEB_Resize_Retailer_800x514.png', avg_rating: 5, avg_cost: '$'},
  { name: "Archie’s New York Deli", street: "101 Arch St", city: "Boston", state: "MA", zip: "02110", description: "Daytime deli serving bagels, breakfast items, salads & sandwiches, including Reubens & house combos.", image: "https://img.grouponcdn.com/deal/xwmbBk6zL81uwLTogVhvrz/95825871-700x420/v1/c700x420.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "Chacarero", street: "101 Arch St", city: "Boston", state: "MA", zip: "02110", description: "Popular spot (especially for lunch) for homemade Chilean sandwiches served at the counter.", image: "https://www.seriouseats.com/recipes/images/2017/06/20170623-steak-sandwich-chacarero36-1500x1125.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "163 Vietnamese Sandwiches & Bubble Tea", street: "66 Harrison Ave", city: "Boston", state: "MA", zip: "02110", description: "Miniature shop specializing in Vietnamese-style sandwiches & prepackaged meals for carryout.", image: "https://www.onlinefoodblog.com/wp-content/uploads/2018/08/Vietnamese-Banh-Mi-Sandwich.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "Wai Wai", street: "26 Oxford St", city: "Boston", state: "MA", zip: "02110", description: "Modest Chinese nook with a menu emphasizing roasted meats & ice cream in flavors such as ginger.", image: "https://s3-media4.fl.yelpcdn.com/bphoto/4Iccy5Si8J7LAc0lTZ_9iw/o.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "Chicken and Rice Guys", street: "280 Washington St", city: "Boston", state: "MA", zip: "02110", description: "When we opened our first food truck back in 2012, we had one goal: introduce you nomivores to the ridiculously delicious world of chicken and rice. With high quality ingredients, alluring aromas, and the seduction of self-saucing, we knew our halal grub would be a hit.", image: "https://s3-media1.fl.yelpcdn.com/bphoto/cPacIxshHm41x4ZlJid57g/o.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "Pho Pasteur", street: "682 Washington St", city: "Boston", state: "MA", zip: "02110", description: "Quick-serve spot for oversized bowls of Vietnamese noodle soup & traditional entrees.", image: "https://s3-media2.fl.yelpcdn.com/bphoto/U1PgH8uoa4aqFC4DHV93jA/o.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "Tora", street: "20B Tyler St", city: "Boston", state: "MA", zip: "02110", description: "Poke bowls and kaisen don (sashimi and rice bowls) are emphasized at this intimate Japanese eatery.", image: "https://s3-media2.fl.yelpcdn.com/bphoto/Zp0LBuKTX5RO6ZiCA80bzw/o.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "The Halal Guys", street: "137 Stuart St", city: "Boston", state: "MA", zip: "02110", description: "From humble beginnings as a New York City hot dog cart to a world-renowned international restaurant chain, The Halal Guys story is the quintessential American Dream. The Halal Guys is defining a new, thriving segment for the restaurant industry: American Halal Food!", image: "https://s3-media2.fl.yelpcdn.com/bphoto/_uw4ty1-7XfLnzWZWdWx9w/o.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "Sam Lagrassas", street: "44 Province St", city: "Boston", state: "MA", zip: "02110", description: "Longtime family-run shop acclaimed for specialty sandwiches & only open for lunch on weekdays.", image: "https://s3-media3.fl.yelpcdn.com/bphoto/JcSU7Vgu3iQPrJ60FMLiUA/o.jpg", avg_rating: 5, avg_cost: "$"},
  { name: "Deli 1", street: "85 Arch St", city: "Boston", state: "MA", zip: "02110", description: "Deli food from along ago.", image: "https://s3-media4.fl.yelpcdn.com/bphoto/DE3iY43BklcRtoAsdtXYBg/o.jpg", avg_rating: 5, avg_cost: "$"}
]
